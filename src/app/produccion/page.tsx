...
function ProductionContent() {
  ...
  const { recipes, calculateProduction, addProduction, productionCosts, updateProductionCost } = useStore()
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {selectedRecipe.ingredients.map(ing => (
                  <div key={ing.ingredient_id} className="flex items-center gap-2 text-sm">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <input 
                        ...
                        className="w-16 p-1 border rounded bg-background text-right"
                      />
